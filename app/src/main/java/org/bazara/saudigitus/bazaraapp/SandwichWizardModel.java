...
import org.bazara.saudigitus.bazaraapp.wizard.model.AbstractWizardModel;
import org.bazara.saudigitus.bazaraapp.wizard.model.BranchPage;
import org.bazara.saudigitus.bazaraapp.wizard.model.CustomerInfoPage;
import org.bazara.saudigitus.bazaraapp.wizard.model.MultipleFixedChoicePage;
import org.bazara.saudigitus.bazaraapp.wizard.model.PageList;
import org.bazara.saudigitus.bazaraapp.wizard.model.SingleFixedChoicePage;
                ...
                new BranchPage(this, "Select one options")
                        .addBranch("Branch One",
                                ...
                                new MultipleFixedChoicePage(this, "Question Two")
                                        .setChoices("A", "B", "C", "D",
                                                "E"),
                                new CustomerInfoPage(this, "Info").setRequired(true)
                        )
